...
void loop() {
  ...
  // get values
  gas0 = analogRead(gaspin0);
  
  gas0pk = max(gas0pk, gas0);
  ...
  if (GPS.newNMEAreceived()) {
    ...
    logfile.print(gas0); //append gas 0
    logfile.print(",");
    logfile.print(gas0av); //append gas 0 average
    logfile.print(",");
    logfile.print(gas0pk); //append gas 0 peak
    logfile.println("");
