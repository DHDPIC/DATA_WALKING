...
void setup() {
  ...
  lons = new FloatList();
  //
  table = loadTable("20160127.csv", "header");
...
void draw() {
  ...
  if (findClosest) {
    ...
    findClosest = false;
    println("data id = " + id);
    print("light: " + table.getFloat(id, 4)+", ");
    print("sound value: " + table.getFloat(id, 5)+", ");
    print("sound average: " + table.getFloat(id, 6)+", ");
    print("sound peak: " + table.getFloat(id, 7)+", ");
    print("temperature: " + table.getFloat(id, 8)+" ");
  }
  //
