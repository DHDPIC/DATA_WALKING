...
void loop() {
  ...
  int brightness = map(sound,128,512,0,255);
  ...
  if (GPS.newNMEAreceived()) {
    ...
    // if you get weird doubling or seesawing (hi followed by lo value) of writing data
    // then uncomment this conditional and matching brace below
    if (soundInc > 1) {
      // log location and time data
      ...
      logfile.println("");
    } //this is the matching brace to uncomment!
